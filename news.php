...
<head>
    ...
    <body>
        ...
        <div class="body-wrapper">
                                        ...
                                        <li>
                                            ...
                                            <div class="setting ht-setting">
                                                <ul class="ht-setting-list">
                                                    ...
                                                    <li><a href="checkout.hphp">THANH TOÁN </a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="li-blog-banner">
                                                    <a href="#"><img class="img-full" src="images/blog-banner/5.jpg" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="li-blog-content">
                                                    <div class="li-blog-details">
                                                        <h3 class="li-blog-heading pt-xs-25 pt-sm-25"><a href="blog-details-left-sidebar.html">bài 1</a></h3>
                                                        <div class="li-blog-meta">
                                                            <a class="author" href="#"><i class="fa fa-user"></i>Admin</a>
                                                            <a class="comment" href="#"><i class="fa fa-comment-o"></i> 3 comment</a>
                                                            <a class="post-time" href="#"><i class="fa fa-calendar"></i> 29 nov 2020</a>
                                                        </div>
                                                        <p>
			...
			echo "<em>Posted:" .$row['createdate']. "</em><br/>";
